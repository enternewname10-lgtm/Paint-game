 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function yp(i,e,t=!1){if(En(i.app))return Promise.reject(Gn(i));const n="signIn",s=await vp(i,n,e),r=await $i._fromIdTokenResponse(i,n,s);return t||await i._updateCurrentUser(r.user),r}async function f0(i,e){return yp(Qi(i),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function xp(i){const e=Qi(i);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function p0(i,e,t){if(En(i.app))return Promise.reject(Gn(i));const n=Qi(i),o=await Jl(n,{returnSecureToken:!0,email:e,password:t,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",h0).catch(l=>{throw l.code==="auth/password-does-not-meet-requirements"&&xp(i),l}),a=await $i._fromIdTokenResponse(n,"signIn",o);return await n._updateCurrentUser(a.user),a}function m0(i,e,t){return En(i.app)?Promise.reject(Gn(i)):f0(Nt(i),Zs.credential(e,t)).catch(async n=>{throw n.code==="auth/password-does-not-meet-requirements"&&xp(i),n})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bn(){return window}function C0(i){bn().location.href=i}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Tp(){return typeof bn().WorkerGlobalScope<"u"&&typeof bn().importScripts=="function"}async function A0(){if(!(navigator!=null&&navigator.serviceWorker))return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function R0(){var i;return((i=navigator==null?void 0:navigator.serviceWorker)===null||i===void 0?void 0:i.controller)||null}function I0(){return Tp()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const iy=new Kr(3e4,6e4);function Bu(){const i=bn().___jsl;if(i!=null&&i.H){for(const e of Object.keys(i.H))if(i.H[e].r=i.H[e].r||[],i.H[e].L=i.H[e].L||[],i.H[e].r=[...i.H[e].L],i.CP)for(let t=0;t<i.CP.length;t++)i.CP[t]=null}}function sy(i){return new Promise((e,t)=>{var n,s,r;function o(){Bu(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{Bu(),t(Mn(i,"network-request-failed"))},timeout:iy.get()})}if(!((s=(n=bn().gapi)===null||n===void 0?void 0:n.iframes)===null||s===void 0)&&s.Iframe)e(gapi.iframes.getContext());else if(!((r=bn().gapi)===null||r===void 0)&&r.load)o();else{const a=Yv("iframefcb");return bn()[a]=()=>{gapi.load?o():t(Mn(i,"network-request-failed"))},mp(`${$v()}?onload=${a}`).catch(l=>t(l))}}).catch(e=>{throw Go=null,e})}let Go=null;function ry(i){return Go=Go||sy(i),Go}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ky{constructor(){this.cache_={},this.isInMemoryStorage=!0}set(e,t){t==null?delete this.cache_[e]:this.cache_[e]=t}get(e){return Cn(this.cache_,e)?this.cache_[e]:null}remove(e){delete this.cache_[e]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tx{constructor(){this.counters_={}}incrementCounter(e,t=1){Cn(this.counters_,e)||(this.counters_[e]=0),this.counters_[e]+=t}get(){return V_(this.counters_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let tc;function Ox(i){tc=i}const im=function(i){return typeof i=="number"?"number:"+Up(i):"string:"+i},sm=function(i){if(i.isLeafNode()){const e=i.val();Z(typeof e=="string"||typeof e=="number"||typeof e=="object"&&Cn(e,".sv"),"Priority must be a string or number.")}else Z(i===tc||i.isEmpty(),"priority of unexpected type.");Z(i===tc||i.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hd=10*1e3,Qx=30*1e3,eS=5*60*1e3;class tS{constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new Zx(e);const n=hd+(Qx-hd)*Math.random();Er(this.reportStats_.bind(this),Math.floor(n))}reportStats_(){const e=this.statsListener_.get(),t={};let n=!1;Lt(e,(s,r)=>{r>0&&Cn(this.statsToReport_,s)&&(t[s]=r,n=!0)}),n&&this.server_.reportStats(t),Er(this.reportStats_.bind(this),Math.floor(Math.random()*2*eS))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
void main() {
  ...
  `,fi.appendChild(t),Sn={destroy:()=>t.remove()},t.querySelector("#go-home").addEventListener("click",()=>en("home"))}const ho=document.createElement("div");ho.className="screen";ho.id="loading-screen";ho.innerHTML=`
